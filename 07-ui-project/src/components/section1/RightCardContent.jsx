...
const RightCardContent = () => {
  return (
    <div className='absolute top-0 left-0 h-full w-full bg-transparent p-4 flex flex-col justify-between'>
        ...
        <div>
            <p className='text-black text-lg leading-normal mb-10'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fuga magnam quibusdam autem adipisci omnis accusantium.</p>
